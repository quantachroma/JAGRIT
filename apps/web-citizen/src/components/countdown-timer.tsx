...
export default function CountdownTimer({ deadlineISO, bids = 2, ticketId, compact = false }: CountdownTimerProps) {
  ...
  return (
    <section aria-label="10-day bidding countdown" className="rounded-xl border border-[#F1F5F9] bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-center gap-2">
        <p className="inline-flex items-center gap-1.5 text-xs font-semibold uppercase tracking-wide text-[#2563EB]">
      ...
      <div className="mt-3">
        {closed ? (
          ...
          <p className="flex items-center gap-1.5 rounded-lg bg-sky-100 px-3 py-2 text-xs font-semibold text-sky-900">
