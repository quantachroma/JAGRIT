    ...
    <div className="flex h-full flex-col">
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-[#F1F5F9] px-3 py-2 text-sm outline-none focus:border-[#2563EB]"
          />
      ...
      <div className="mt-4 flex-1 space-y-3 overflow-y-auto pb-2">
        ...
        {result.materials.map((m) => (
          <div key={m.title} className="rounded-lg border border-[#F1F5F9] p-3">
        ...
        {result.warnings.map((w) => (
          <p key={w.id} role="alert" className="flex items-start gap-1.5 rounded-lg bg-sky-50 px-3 py-2 text-xs font-semibold text-sky-900">
