...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const syncLanguage = () => {
      ...
      const stored = (window.localStorage.getItem('jagrit_language') || window.localStorage.getItem('jagrit_citizen_lang')) as AppLanguage | null;
  ...
  const setLanguage = (next: AppLanguage) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      window.localStorage.setItem('jagrit_citizen_lang', next);
