...
function LayoutContent({ children }: { children: React.ReactNode }) {
  ...
  const role: NavRole = user.role
    ? ROLE_ALIASES[user.role] || (user.role as NavRole)
    : 'CITIZEN';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <div className="flex-1 md:ml-60 min-h-screen flex flex-col">
        <header className="h-14 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between sticky top-0 z-30 shadow-sm">
