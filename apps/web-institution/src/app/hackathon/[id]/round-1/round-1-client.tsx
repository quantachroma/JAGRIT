        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-[#E2E8F0] bg-white p-4 shadow-sm">
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li className="flex items-center gap-2"><span className="w-44 shrink-0 font-semibold">Innovation (40%)</span><span className="h-2 flex-1 overflow-hidden rounded-full bg-slate-200"><span className="block h-full w-[40%] rounded-full bg-[#4F46E5]" /></span></li>
              <li className="flex items-center gap-2"><span className="w-44 shrink-0 font-semibold">Technical Feasibility (30%)</span><span className="h-2 flex-1 overflow-hidden rounded-full bg-slate-200"><span className="block h-full w-[30%] rounded-full bg-[#044728]" /></span></li>
              <li className="flex items-center gap-2"><span className="w-44 shrink-0 font-semibold">Local Context (30%)</span><span className="h-2 flex-1 overflow-hidden rounded-full bg-slate-200"><span className="block h-full w-[30%] rounded-full bg-amber-500" /></span></li>
            </ul>
