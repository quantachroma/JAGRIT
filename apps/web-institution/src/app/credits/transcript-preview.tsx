  ...
  return (
    <div className="overflow-hidden rounded-xl border-2 border-[#1E3A8A]">
      <div className="bg-[#1E3A8A] px-4 py-3 text-center text-white">
        <p className="text-[11px] uppercase tracking-widest text-sky-200">Government of Jharkhand · DHTE</p>
        <p className="text-base font-bold">DigiLocker / APAAR Academic Transcript</p>
        <p className="text-[11px] text-sky-100">National Academic Depository · Academic Bank of Credits</p>
      </div>
