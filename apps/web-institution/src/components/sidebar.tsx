...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 border-r border-[#E2E8F0] bg-white md:block">
      <nav className="space-y-1 p-4" aria-label="Institution navigation">
        ...
        >
          <Lightbulb className="h-4 w-4 text-amber-500" />Student R&amp;D Copilot
          <span className="ml-auto rounded bg-indigo-100 px-1.5 py-0.5 text-[10px] font-semibold text-[#4F46E5]">SLIDE-OUT</span>
        </button>
        {links.slice(2).map((l) => (
